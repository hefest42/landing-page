...
section1.addEventListener("mouseover", function(e) {
    ...
    if (e.target.classList.contains("plan-button")) {
        ...
        document.querySelector(`.plan-button-${id}`).classList.add("button-highlight");

        document.querySelector(`.plan-description-${id}`).classList.add("plan-description-hover");
    }
})
...
section1.addEventListener("mouseout", function(e) {
    ...
    if (e.target.classList.contains("plan-button")) {
        ...
        document.querySelector(`.plan-button-${id}`).classList.remove("button-highlight");

        const image = document.querySelector(`.plan-description-${id}`).classList.remove("plan-description-hover");
    }
})
